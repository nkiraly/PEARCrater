...
require_once __DIR__ . '/PEARCraterTask/Changelog.php';
require_once __DIR__ . '/PEARCraterTask/Dependencies.php';
require_once __DIR__ . '/PEARCraterTask/Description.php';
require_once __DIR__ . '/PEARCraterTask/Exception.php';
require_once __DIR__ . '/PEARCraterTask/Frontend.php';
require_once __DIR__ . '/PEARCraterTask/KeyedContainer.php';
require_once __DIR__ . '/PEARCraterTask/License.php';
require_once __DIR__ . '/PEARCraterTask/Maintainer.php';
require_once __DIR__ . '/PEARCraterTask/Stability.php';
require_once __DIR__ . '/PEARCraterTask/TextContainer.php';
require_once __DIR__ . '/PEARCraterTask/Version.php';

class PEARCraterTask extends Task {

  protected $taskName = 'PEARCrater';
  private $_name = null;
  ...
  /**
   * Handles the baseinstalldir attribute of PEARCrater
   *
  ...
  /**
   * Handles the dir attribute of PEARCrater
   *
  ...
  /**
   * Handles the the filelistgenerator attribute of PEARCrater
   *
  ...
  /**
   * Handles "type" attributes of <PEARCrater> task
   * 
   ...
   *
   *
   * @return PEARCraterTask_KeyedContainer
   */
  public function createInstallExceptions() {
    $exception = new PEARCraterTask_KeyedContainer();
  ...
  public function createDirRoles() {
    $dir_role = new PEARCraterTask_KeyedContainer();
   ...
   *
   *
   * @return PEARCraterTask_TextContainer
   */
  public function createIgnore() {
    $ignore = new PEARCraterTask_TextContainer();
  ...
  public function createName() {
    ...
    $this->_name = new PEARCraterTask_TextContainer();
    return $this->_name;
  }
  ...
  public function createSummary() {
    ...
    $this->_summary = new PEARCraterTask_TextContainer();
  ...
  public function createDescription() {
    ...
    $this->_description = new PEARCraterTask_Description();
  ...
  public function createChannel() {
    ...
    $this->_channel = new PEARCraterTask_TextContainer();
   ...
   *
   * Note that the returned {@link PEARCraterTask_Maintainer} object will already have a role of
   * lead when this method is invoked
   *
   *
   * @return PEARCraterTask_Maintainer
   */
  public function createLead() {
    $lead = new PEARCraterTask_Maintainer();
    $lead->setRole('lead');
  ...
  public function createDeveloper() {
    $developer = new PEARCraterTask_Maintainer();
  ...
  public function createContributor() {
    $contributor = new PEARCraterTask_Maintainer();
  ...
  public function createHelper() {
    $helper = new PEARCraterTask_Maintainer();
  ...
  public function createDate() {
    $this->_date = new PEARCraterTask_TextContainer();
    return $this->_date;
  }
   ...
   *
   *
   * @return PEARCraterTask_License
   */
  public function createLicense() {
    $this->_license = new PEARCraterTask_License();
   ...
   *
   *
   * @return PEARCraterTask_Version
   */
  public function createVersion() {
    $this->_version = new PEARCraterTask_Version();
   ...
   * 
   * 
   * @return PEARCraterTask_Stability
   */
  public function createStability() {
    $this->_stability = new PEARCraterTask_Stability();
  ...
  public function createNotes() {
    $this->_notes = new PEARCraterTask_TextContainer();
    return $this->_notes;
  }
  ...
  public function createDependencies() {
    $this->_dependencies = new PEARCraterTask_Dependencies();
   ...
   *
   *
   * @return PEARCraterTask_Changelog
   */
  public function createChangelog() {
    $changelog = new PEARCraterTask_Changelog();
   ...
   *
   *
   * @return PEARCraterTask_Replacement
   */
  public function createReplacement() {
    require_once 'PEARCraterTask/Replacement.php';
    $replacement = new PEARCraterTask_Replacement();
   ...
   *
   *
   * @return PEARCraterTask_Release
   */
  public function createRelease() {
    require_once 'PEARCraterTask/Release.php';
    $release = new PEARCraterTask_Release();
  ...
  private function _insureOnlyOnePresent($key) {
    ...
    throw new PEARCraterTask_Exception("<{$key}> can only be called once");
  }
